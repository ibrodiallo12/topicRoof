  ...
  <body>
	  <div class="container">
		...
		<div class="row div_center">
			...
			<h3 class="h3 text-muted">Check your information before saving</h3>
	        ...
	        <div class="row col-lg-9 div_print_option">
	        	  ...
	        	  <div class="div_form_option">
					...
					<div class="alert col-lg-10 alert-danger" id="alert_Error">
						<strong>WARNING! DO YOU WANT TO CLOSE YOUR ACCOUNT ???</strong>
					</div>

		       <!-- form option-->
		            <form class="form-horizontal col-lg-10 form_option" method="post" action="#" id="form_signUp">
						  <div class="form-group">
							<legend><h2 class="text-muted alert-danger"><span class="glyphicon glyphicon-remove"></span> Close your account</h2></legend>
						  </div>
							...
							<div class="input-group col-lg-12"> 
								  <label class="input-group-addon" for="close">Close now</label>
								  <input type="checkbox"  name="close" class="form-control" id="close" />
							 </div>
							
							<div class="row"> 
								<div class="col-lg-12">
									<input type="submit" class="btn btn-danger btn-block form-control" name="submit" value="Close my account">
								</div>
							 </div>
