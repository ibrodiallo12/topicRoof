		       ...
		       <!-- form option-->
		            <form class="form-horizontal col-lg-10 form_option" method="post" action="#" id="form_signUp">
						  <div class="form-group">
							<legend><h2 class="text-muted"><span class="glyphicon glyphicon-user"></span> Change your photo</h2></legend>
						  </div>
							...
							<div class="input-group col-lg-12"> 
								  <label class="input-group-addon" for="avatar">Photo</label>
								  <input type="file"  name="avatar" class="form-control" id="avatar" style="padding-top: 4px;"/>
							 </div>
