  ...
  <body>
	  <div class="container">
			...
			<div class="row col-lg-4 div_member">
				<div class="row col-lg-offset-1 alert-success">
					<h4 class="alert col-lg-offset-1 col-lg-10 btn-primary">
						Member <span class="glyphicon glyphicon-user pull-right"></span>
					</h4>
					<div>
						<ul>
							<li class="col-lg-12">
								...
								<button class="row btn btn-primary btn-xs"><span class="glyphicon glyphicon-hand-right"></span></button>
							</li>
							<li class="col-lg-12">
								<!--presentation_topic -->
								<div class="row presentation_topic">
		...
		<div class="row div_center">
			...
			<div class="row div_message_center">
				
				<form class="navbar-form col-lg-4 search_member">
				  <span class="text-muted">Write a new message: </span>
				  <input type="text" class="form-control" placeholder="Search">
				  <button type="submit" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-search"></span></button>
			     </form>
	        </div>
	        <div class="row col-lg-9 div_print_message">
	        	  <h3><span class="text-muted">With: </span>SOphei leasfasdfaOl</h3>
	        	  
	        	  <div class="alert  alert-success" style="width: 490px;">
					 <form class="navbar-form">
						  <textarea  class="form-control" placeholder="Write a message" style="width: 400px;"/></textarea>
						  <button type="submit" class="btn btn-primary btn-xs" style="margin-bottom: 0px;">
							  <span class="glyphicon glyphicon-send"></span>
						  </button>
					  </form>
				 </div>
	        	  <div class="presentation_message_user">
			    	  	<div class="message_user">
			    	  		<span class="pull-right text-muted">15-1555 mas</span>
			    	  	  <img class="img-circle img_avatar" src="bootstrap/icon/bigger.jpeg" alt="Generic placeholder image"/>
						  <h4><strong>Hello, wo!</strong></h4>
						  <p>..kljl;fajsasdfasdfasdfasdfasdfasdfasdfasdfadf asdfasdfal;dfjasd.</p>
						</div>
	        	  </div>
