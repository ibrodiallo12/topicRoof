	  ...
	  <div class="container">
		...
		<div class="row">
			<div class="alert col-lg-offset-1 col-lg-10 alert-success">
				 <form class="navbar-form" id="form_topic">
					  <input type="text" class="form-control" placeholder="Write your topic!">
		...
		<div class="row div_center">
			...
			<div class="col-lg-5" id="left">
				<div class="row">
					<a href="#">
						<div class="alert col-lg-offset-1 col-lg-10 alert-success">
							<strong>ToPiC <span class="badge pull-right">250</span> </strong>
						</div>
					</a>
				</div>
				<!--presentation_topic -->
				<div class="row presentation_topic">
					  ...
					  <h2 class="username">Sophie lebel</h2>
					  <p class="p_topic">dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, pna.</p>
					  <!--div_shareComment-->
					  <div class="row div_shareComment">
						  <p><a class="btn btn-default" href="#" role="button"><span class="glyphicon glyphicon-share">Share</span></a></p>
				...
				<div class="row">
					<a href="#">
						<div class="alert col-lg-offset-1 col-lg-10 alert-danger">
							<strong>RooF <span class="badge pull-right">150</span></strong>
						</div>
					</a>
				</div>
