				...
				<div class="row col-lg-offset-1 alert-success">
					...
					<div>
						<ul>
							...
							<li class="col-lg-12 last_li_user">
								<div>
									  <img src="bootstrap/icon/bigger.jpeg" alt="Photo" style="height: 150px; 
	width: 200px; margin: auto;"/>
									  <div class="text-muted">
										<h3>sophie label</h3>
										<a href="#" title="change your photo" class="text-muted">Change your photo</a>
									  </div>
								</div>
							</li>
		...
		<div class="row div_center">
	        ...
	        <div class="row col-lg-9 div_print_option">
	        	  ...
	        	  <div class="div_form_option">
					...
					<div class="alert col-lg-10 alert-danger" id="alert_Error" style="text-align: center;">
		       ...
		       <!-- form option-->
		            <form class="form-horizontal col-lg-10 form_option" method="post" action="#" id="form_signUp">
						  <div class="form-group">
							<legend><h2 class="text-muted">Change your name</h2></legend>
						  </div>
